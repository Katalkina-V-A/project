class Picture < ActiveRecord::Base
  ...
  has_attached_file :image, styles: { large: "500x500", medium: "300x300>", thumb: "100x100>" },
    :default_url => "/assets/images/avatars/:style/missing.png",
     :url  => "/assets/images/:attachment/:id/:style_:filename",
     :path => ":rails_root/app/assets/images/:attachment/:id/:style_:filename"
